...
const DashboardLogin = () => {
  ...
  const { setDashboardToken } = useContext(AppContext);
  ...
  const onSubmitHandler = async (dashboardData) => {
    try {
      ...
      if (data.success) {
        localStorage.setItem("dashboardToken", data.super_token);
        ...
        <div className="flex justify-center items-center">
          <div className="w-96">
            <div className="bg-green-600 p-10 rounded-lg shadow-lg w-full  text-white text-sm">
              ...
              <p className="text-center text-sm mb-6">Dashboard Analytics</p>
